  ...
  return (
    <header className="pb-0 mb-0" style={{ borderBottom: "1px solid #333" }}>
      {/* <section> */}
        ...
        <img className="socialgarden" src={socialgarden} alt="name of the application in cursive writing" />
      {/* </section> */}
          ...
          { currUser.status === "found" && (
            <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{ display: "flex", justifyContent: "flex-end"}}>
              <li className="nav-item">
                  <span className="nav-link active">Welcome back, {currUser.data.username}</span>
              </li>
              <li className="nav-item">
